...
SOURCE_NAME="dumpvdl2"
SOURCE_VERSION="2.2.0"
SOURCE_GITHUB_REPO="szpajder/dumpvdl2"
SOURCE_URL="https://github.com/${SOURCE_GITHUB_REPO}/archive/refs/tags/v${SOURCE_VERSION}.tar.gz"
DEPENDENCIES="build-essential cmake git libglib2.0-dev pkg-config librtlsdr-dev libsoapysdr-dev libairspy-dev libacars"
